...
pub const Renderer = extern struct {
    ...
    extern fn wlr_renderer_scissor(r: *Renderer, box: *wlroots.Box) void;
    ...
    extern fn wlr_render_rect(r: *Renderer, box: *const Box, color: *const [4]f32, projection: *const [9]f32) void;
    extern fn wlr_render_quad_with_matrix(r: *Renderer, color: *const [4]f32, matrix: *const [9]f32) void;
    extern fn wlr_render_ellipse(r: *Renderer, box: *const Box, color: *const [4]f32, projection: *const [9]f32) void;
    extern fn wlr_render_ellipse_with_matrix(r: *Renderer, color: *const [4]f32, matrix: *const [9]f32) void;
    extern fn wlr_renderer_get_formats(r: *Renderer, len: *usize) [*]const enum_wl_shm_format;
    ...
    extern fn wlr_renderer_get_dmabuf_formats(renderer: *Renderer) *const struct_wlr_drm_format_set;
    extern fn wlr_renderer_read_pixels(r: *Renderer, fmt: enum_wl_shm_format, flags: ?*u32, stride: u32, width: u32, height: u32, src_x: u32, src_y: u32, dst_x: u32, dst_y: u32, data: ?*c_void) bool;
    extern fn wlr_renderer_blit_dmabuf(r: *Renderer, dst: *struct_wlr_dmabuf_attributes, src: *struct_wlr_dmabuf_attributes) bool;
    extern fn wlr_renderer_format_supported(r: *Renderer, fmt: enum_wl_shm_format) bool;
    ...
    pub fn autocreate(egl: *wlroots.EGL, platform: egl.EGLenum, remote_display: ?*c_void, config_attribs: *egl.EGLint, visual_id: egl.EGLint) !*Renderer {
        return wlr_renderer_autocreate(egl, platform, remote_display, config_attribs_visual_id) orelse error.Failure;
    }
    ...
    pub fn getFormats(r: *Renderer) []const enum_wl_shm_format {
